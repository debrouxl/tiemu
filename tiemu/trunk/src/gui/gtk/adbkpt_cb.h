...
void
on_add_data_bkpt_dbox_show             (GtkWidget       *widget,
                                        gpointer         user_data);

void
on_add_data_bkpt_dbox_show19           (GtkWidget       *widget,
                                        gpointer         user_data);

void
on_add_data_bkpt_dbox_show20           (GtkWidget       *widget,
                                        gpointer         user_data);

void
on_add_data_bkpt_dbox_show21           (GtkWidget       *widget,
                                        gpointer         user_data);
