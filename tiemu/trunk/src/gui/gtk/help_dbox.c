...
create_help_dbox (void)
{
  ...
  g_signal_connect ((gpointer) button1, "clicked",
                    G_CALLBACK (help_ok_button_clicked),
                    NULL);

  /* Store pointers to all widgets, for use by lookup_widget(). */
  GLADE_HOOKUP_OBJECT_NO_REF (help_dbox, help_dbox, "help_dbox");
  GLADE_HOOKUP_OBJECT_NO_REF (help_dbox, dialog_vbox1, "dialog_vbox1");
  GLADE_HOOKUP_OBJECT (help_dbox, scrolledwindow1, "scrolledwindow1");
  GLADE_HOOKUP_OBJECT (help_dbox, text1, "text1");
  GLADE_HOOKUP_OBJECT_NO_REF (help_dbox, dialog_action_area1, "dialog_action_area1");
  GLADE_HOOKUP_OBJECT (help_dbox, hbuttonbox1, "hbuttonbox1");
  GLADE_HOOKUP_OBJECT (help_dbox, button1, "button1");
